...
const getMenuItems = (userRole?: string) => {
  ...
  if (userRole === 'admin') {
    return [
      ...
      { name: 'Learning Paths', href: '/dashboard/admin/learning-paths', icon: Route },
      { name: 'Skills Matrix', href: '/dashboard/admin/skills', icon: Sparkles },
      ...
      { name: 'Study Groups', href: '/dashboard/admin/study-groups', icon: Users },
...
export default function Sidebar({ userRole: propUserRole }: SidebarProps) {
  ...
  const menuItems = getMenuItems(userRole || propUserRole || undefined);
